    ...
    <div className="pt-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-200 mb-8">
                Based in Vijayawada, we are a leading solar panel installation company serving Andhra Pradesh and Telangana. Operating across Krishna, Guntur, Visakhapatnam, Hyderabad, and Rangareddy districts. Save money, save the environment, and enjoy reliable clean energy with our comprehensive rooftop solar panels and advanced energy solutions.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See our professional solar panel installations across Andhra Pradesh and Telangana - serving Krishna, Guntur, Visakhapatnam, Hyderabad, and surrounding districts with quality solar solutions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm">Reduce electricity bills by up to 90% with residential solar panels, rooftop solar systems, and home solar power solutions in Krishna, Guntur, Visakhapatnam, Hyderabad, and Rangareddy districts</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm">Cut operational costs and improve your business sustainability with commercial solar panels, business solar systems, and office solar power solutions across Krishna, Guntur, Visakhapatnam, Hyderabad, and Rangareddy districts</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm">Massive energy savings for factories and industrial facilities with industrial solar panels, factory solar systems, and large-scale solar power solutions across Krishna, Guntur, Visakhapatnam, Hyderabad, and Rangareddy districts</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Shri Shiridi Sai Solar?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide comprehensive solar solutions with unmatched quality and service - serving Andhra Pradesh and Telangana with professional solar installation, maintenance, repair, and consultation services
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Serving Andhra Pradesh and Telangana including Vijayawada, Guntur, Visakhapatnam, Hyderabad, and surrounding areas. Join the growing community that has already transitioned to sustainable power. Contact us today for a complimentary solar consultation on rooftop solar panels, integrated solar power systems, and customized solar energy solutions.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
