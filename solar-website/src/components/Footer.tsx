      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold">Vinayaka Solar</h3>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <div className="text-gray-300">
                  <a href="tel:+919100116156" className="hover:text-yellow-500 transition-colors block">+91 9100116156</a>
                  <a href="tel:+919100116056" className="hover:text-yellow-500 transition-colors block">+91 9100116056</a>
                </div>
              </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p className="text-gray-400">
            © {currentYear} Vinayaka Solar. All rights reserved. | 
