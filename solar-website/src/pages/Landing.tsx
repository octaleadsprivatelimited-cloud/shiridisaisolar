        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h1 className="text-xl sm:text-2xl font-bold text-white">Vinayaka Solar</h1>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <a href="tel:+919100116156" className="text-white hover:text-yellow-400 transition-colors text-sm sm:text-base">
                <Phone className="h-4 w-4 sm:h-5 sm:w-5 inline mr-1" />
                <span className="hidden sm:inline">+91 9100116156</span>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-gray-900">Contact Vinayaka Solar</h2>
